...
const FIELDS = {
  provider: {
    ...
    availabilitySpecifics: ["Availability Specifics", "Availability Details", "Availability Notes"],
...
async function getDirectoryOptions() {
  return {
    ...
    currentAvailability: await selectOptions("directory", FIELDS.provider.currentAvailability),
