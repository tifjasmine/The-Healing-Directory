...
function LotusMark() {
  return <svg viewBox="0 0 64 64" focusable="false">
    <path d="M32 47c-7.6-5.8-11.4-12.5-11.4-20.1 0-6.8 3.8-12.6 11.4-17.4 7.6 4.8 11.4 10.6 11.4 17.4C43.4 34.5 39.6 41.2 32 47Z" />
    <path d="M31.6 47.3c-8.2-.3-14.9-3.2-20.1-8.7-4.3-4.6-5.8-10.2-4.5-16.9 7.5.5 13.5 3.1 18 7.8 4.5 4.8 6.7 10.7 6.6 17.8Z" />
    <path d="M32.4 47.3c8.2-.3 14.9-3.2 20.1-8.7 4.3-4.6 5.8-10.2 4.5-16.9-7.5.5-13.5 3.1-18 7.8-4.5 4.8-6.7 10.7-6.6 17.8Z" />
    <path d="M14 47.2c5.3 4.5 11.3 6.7 18 6.7s12.7-2.2 18-6.7" />
  </svg>;
}
