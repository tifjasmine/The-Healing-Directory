...
function HeartFlowerMark() {
  return <svg viewBox="0 0 32 32" focusable="false">
    <path d="M16 25.3C9.5 20.7 6.2 16.6 6.2 12.8c0-3.1 2.2-5.3 5.1-5.3 2 0 3.6 1 4.7 2.8 1.1-1.8 2.7-2.8 4.7-2.8 2.9 0 5.1 2.2 5.1 5.3 0 3.8-3.3 7.9-9.8 12.5Z" />
    <path d="M11.1 15.4c2.4-.4 4 .4 4.9 2.3.9-1.9 2.5-2.7 4.9-2.3" />
  </svg>;
}
