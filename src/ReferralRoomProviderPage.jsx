...
function LotusMark() {
  return <svg viewBox="0 0 48 48" focusable="false">
    <path d="M24 6c5.8 5.1 8.5 10.6 8.1 16.5C31.6 29 28.9 33 24 34c-4.9-1-7.6-5-8.1-11.5C15.5 16.6 18.2 11.1 24 6Z" />
    <path d="M12.4 13.7c6.3 1.8 10.3 5 12 9.5 1.9 5 .5 9.2-4.1 12.5-5.6-.4-9.2-3-10.8-7.8-1.5-4.6-.6-9.3 2.9-14.2Z" />
    <path d="M35.6 13.7c3.5 4.9 4.4 9.6 2.9 14.2-1.6 4.8-5.2 7.4-10.8 7.8-4.6-3.3-6-7.5-4.1-12.5 1.7-4.5 5.7-7.7 12-9.5Z" />
    <path d="M6.5 25.4c6.6-.8 11.4.4 14.5 3.7 3 3.2 3.4 6.9 1.2 11.1-5.5 1.3-10 .4-13.3-2.7-3-2.8-3.8-6.8-2.4-12.1Z" />
    <path d="M41.5 25.4c1.4 5.3.6 9.3-2.4 12.1-3.3 3.1-7.8 4-13.3 2.7-2.2-4.2-1.8-7.9 1.2-11.1 3.1-3.3 7.9-4.5 14.5-3.7Z" />
  </svg>;
}
