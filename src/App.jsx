...
function ProviderOnlySection({ provider }) {
  ...
  return (
    <ContentSection title="Provider connection details">
      {rows.length ? (
...
function ContentSection({ kicker, title, children }) { return <section className="content-section">{kicker ? <p className="eyebrow ink">{kicker}</p> : null}{title ? <h2>{title}</h2> : null}{children}</section>; }
